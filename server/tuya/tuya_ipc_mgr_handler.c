...
#define IPC_APP_STORAGE_PATH    "/etc/conf.d/jovision/"
#define IPC_APP_UPGRADE_FILE    "/etc/conf.d/jovision/upgrade.file"
#define IPC_APP_SD_BASE_PATH    "./rec/00/"
#define IPC_APP_PID             "EQ5wrKFG9lPFGlUw"
#define IPC_APP_UUID            "tuyacbb5e0fdd2b47805"
#define IPC_APP_AUTHKEY         "xn2NN5rLJJtXQm2cfusvnIKzBCYvnGOh"
#define IPC_APP_P2PID           "DN529ZKKVX1ZS5JR111A"
